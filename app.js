...
app.use((req,res,next)=>{
    ...
    res.header("Access-Control-Allow-Header",'origin,X-Requested-Width,Content-Type,Authorization');
    if(req.method==="OPTION"){
        res.header("Access-Control-Allow-Methods","PUT,POST,PATCH,OPTION,DELETE,GET");
